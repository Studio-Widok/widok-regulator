...
/* harmony import */ var _widok_regulator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../widok-regulator */ "./widok-regulator.js");


var dot = cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#dot');
var reg = (0,_widok_regulator__WEBPACK_IMPORTED_MODULE_1__.default)({
  initialValues: {
    position: 0
  },
 ...
 */
var Regulator = /*#__PURE__*/function () {
  function Regulator(options) {
  ...
  _createClass(Regulator, [{
    ...
    key: "animate",
    value: function animate(target, jump) {
      var targetNames = Object.getOwnPropertyNames(target);
    ...
    value: function animationStep() {
      ...
      for (var i = 0; i < this.names.length; i++) {
        var property = this.x[this.names[i]];

        if (property.isAnimating) {
          var diff = property.target - property.value;
          var eddx = this.transformEddx === undefined ? property.eddx : this.transformEddx(property.eddx, this.names[i]);
          diff += eddx;

          if (property.edx) {
            property.value += property.edx;
          } else {
            property.dx += Math.max(Math.min(diff, this.options.saturation), -this.options.saturation);
          ...
          if (property.edx !== 0 || Math.abs(property.dx) > 0.001 || Math.abs(diff) > 0.01) {
            nextStep = true;
          }
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createRegulator);
...
/******/ 	__webpack_require__("./example/src/scss/base.scss");
/******/ })()
;
